...
function __tide_report_moon_phase_from_unix --argument-names unix_time
...
function __tide_report_provider_moon_local --argument-names moon_cache timeout_sec lock_var
