# Vendored from jorgebucaran/fishtape.
# Source: https://github.com/jorgebucaran/fishtape
# Version: 3.0.1 (latest release tag; no newer tag as of refresh)
# Upstream commit: e6e5fc23dd062ee5ed11828951bf2c85d6798db5 (main)
# Upstream tag commit: 21ccd8c0742b2549093fe5918b0bd565dd43a9ba (3.0.1)
# Upstream file: functions/fishtape.fish
# Refreshed: 2026-05-30
#
# Vendor refresh procedure: (1) Check https://github.com/jorgebucaran/fishtape/releases
# and main for commits after the vendored tag; prefer a release tag when available, or
# document a specific main commit if accepting pre-release fixes. (2) Replace this file
# from upstream functions/fishtape.fish and update the header (version, commit hash,
# refresh date); keep vendor/fishtape.LICENSE in sync with upstream LICENSE.md. (3) Run
# fish scripts/run_tests_isolated.fish and, when applicable,
# env RUN_NETWORK_TESTS=1 fish scripts/run_tests_isolated.fish; fix any Fishtape API
