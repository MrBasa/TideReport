...
# Version: 3.0.1
# Upstream tag commit: 21ccd8c0742b2549093fe5918b0bd565dd43a9ba
# Upstream file: functions/fishtape.fish
# Refresh by replacing this file from the upstream tagged source and keeping
# vendor/fishtape.LICENSE in sync with the upstream MIT license.
...
function fishtape --description "Test scripts, functions, and plugins in Fish"
 ...
 case "" -h --help
 echo "Usage: fishtape Run test files"
 echo "Options:"
